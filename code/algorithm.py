...
################
converted_dir = 'C:/Users/jesly/ECS-111-Emotion-Detection/data/converted'
img_size = (224, 224)

df = pd.read_csv('C:/Users/jesly/ECS-111-Emotion-Detection/data/training_onehot.csv')
...
plt.tight_layout()
plt.savefig('C:/Users/jesly/ECS-111-Emotion-Detection/confusion_matrix.png')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('C:/Users/jesly/ECS-111-Emotion-Detection/accuracyplot.png')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('C:/Users/jesly/ECS-111-Emotion-Detection/lossplot.png')
